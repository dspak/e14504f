...
However, upon completing this it appears the sequenced regions of ITS1, RPB2 and TEF1 are quite (and quite surprisingly) distinct. Looks like we may have to go back to the drawing board (which is above, and possibly with new sequences).
